...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 25.76
  #define DEFAULT_bedKi 2.96
  #define DEFAULT_bedKd 149.22
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 21, -17, -1.93 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 10, (Y_MAX_POS - 5), 10 }
...
#define PRINTCOUNTER
  ...
  #define PRINTCOUNTER_SAVE_INTERVAL 0 // Save at job end; periodic EEPROM writes can disrupt TinyBee I2S stepping.
#endif
